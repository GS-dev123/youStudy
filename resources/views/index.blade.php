...
<head>
      ...
      <title>YouStudy - O mundo do conhecimento</title>
      <!-- Favicon Icon -->
   ...
   <body id="page-top">
      <nav class="navbar navbar-expand navbar-light bg-white static-top osahan-nav sticky-top">
         ...
         <a class="navbar-brand mr-1" href="index.html"><img class="img-fluid" alt="" src="{{asset('assets/img/logo1.png')}}"></a>
         <!-- Navbar Search -->
               ...
               <div class="container">
                  <div class="row no-gutters">
                     <div class="col-lg-6 col-sm-6">
                        <p class="mt-1 mb-0"><strong class="text-dark">You@Study</strong>. 
                           <small class="mt-0 mb-0"><a class="text-primary" target="_blank" href="https://www.templatespoint.net/">Powered by GS Services</a>
                           </small>
                        </p>
                     </div>
